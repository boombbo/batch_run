...
Console.CreateConsoleScreenBuffer.argtypes = [
    ...
    c_void_p,
    DWORD,
    LPVOID]  # DWORD, DWORD, SECURITY_ATTRIBUTES*, DWORD, LPVOID
Console.FillConsoleOutputAttribute.restype = BOOL
Console.FillConsoleOutputAttribute.argtypes = [
    HANDLE, WORD, DWORD, c_int, LPDWORD]  # HANDLE, WORD, DWORD, COORD, LPDWORD
Console.FillConsoleOutputCharacterW.restype = BOOL
Console.FillConsoleOutputCharacterW.argtypes = [
    HANDLE, c_ushort, DWORD, c_int, LPDWORD]  # HANDLE, TCHAR, DWORD, COORD, LPDWORD
...
Console.GetConsoleCursorInfo.argtypes = [
    HANDLE, c_void_p]  # HANDLE, PCONSOLE_CURSOR_INFO
...
Console.GetConsoleScreenBufferInfo.argtypes = [
    HANDLE, c_void_p]  # HANDLE, PCONSOLE_SCREEN_BUFFER_INFO
...
Console.ScrollConsoleScreenBufferW.argtypes = [
    ...
    c_void_p,
    c_int,
    c_void_p]  # HANDLE, SMALL_RECT*, SMALL_RECT*, COORD, LPDWORD
...
Console.SetConsoleCursorInfo.argtypes = [
    HANDLE, c_void_p]  # HANDLE, CONSOLE_CURSOR_INFO*
...
Console.SetConsoleWindowInfo.argtypes = [
    HANDLE, BOOL, c_void_p]  # HANDLE, BOOL, SMALL_RECT*
...
Console.WriteConsoleOutputCharacterW.argtypes = [
    ...
    DWORD,
    c_int,
    LPDWORD]  # HANDLE, LPCTSTR, DWORD, COORD, LPDWORD
