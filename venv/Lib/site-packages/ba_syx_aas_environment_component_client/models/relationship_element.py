...
T = TypeVar("T", bound="RelationshipElement")
...
class RelationshipElement:
    ...
    Attributes:
        ...
        first (Union[Unset, Reference]):
        second (Union[Unset, Reference]):
    """
    ...
    first: Union[Unset, "Reference"] = UNSET
    second: Union[Unset, "Reference"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        second: Union[Unset, Dict[str, Any]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_first, Unset):
            ...
            first = Reference.from_dict(_first)
        ...
        if isinstance(_second, Unset):
            ...
            second = Reference.from_dict(_second)

        relationship_element = cls(
        ...
        relationship_element.additional_properties = d
