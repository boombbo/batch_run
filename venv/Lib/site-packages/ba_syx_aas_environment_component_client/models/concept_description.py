...
T = TypeVar("T", bound="ConceptDescription")
...
class ConceptDescription:
    """
    Attributes:
        is_case_of (Union[Unset, List['Reference']]):
        id (Union[Unset, str]):
    ...
    is_case_of: Union[Unset, List["Reference"]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        is_case_of: Union[Unset, List[Dict[str, Any]]] = UNSET
        if not isinstance(self.is_case_of, Unset):
            is_case_of = []
            for is_case_of_item_data in self.is_case_of:
                is_case_of_item = is_case_of_item_data.to_dict()
                is_case_of.append(is_case_of_item)
        ...
        field_dict.update({})
        if is_case_of is not UNSET:
            field_dict["isCaseOf"] = is_case_of
        if id is not UNSET:
            field_dict["id"] = id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        is_case_of = []
        _is_case_of = d.pop("isCaseOf", UNSET)
        for is_case_of_item_data in _is_case_of or []:
            is_case_of_item = Reference.from_dict(is_case_of_item_data)
        ...
        concept_description.additional_properties = d
