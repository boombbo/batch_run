...
def _get_kwargs(
    ...
    id_short_path: str,
    *,
    level: Union[Unset, GetSubmodelElementByPathSubmodelRepoLevel] = GetSubmodelElementByPathSubmodelRepoLevel.DEEP,
    extent: Union[
        Unset, GetSubmodelElementByPathSubmodelRepoExtent
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        response_200 = SubmodelElement.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        submodel_identifier (str):
        id_short_path (str):
        level (Union[Unset, GetSubmodelElementByPathSubmodelRepoLevel]):  Default:
            GetSubmodelElementByPathSubmodelRepoLevel.DEEP.
        extent (Union[Unset, GetSubmodelElementByPathSubmodelRepoExtent]):  Default:
            GetSubmodelElementByPathSubmodelRepoExtent.WITHOUTBLOBVALUE.
