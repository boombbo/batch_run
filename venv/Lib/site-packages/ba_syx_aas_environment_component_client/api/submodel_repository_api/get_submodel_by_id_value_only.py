...
def _get_kwargs(
    ...
    *,
    level: Union[Unset, GetSubmodelByIdValueOnlyLevel] = GetSubmodelByIdValueOnlyLevel.DEEP,
    extent: Union[Unset, GetSubmodelByIdValueOnlyExtent] = GetSubmodelByIdValueOnlyExtent.WITHOUTBLOBVALUE,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        submodel_identifier (str):
        level (Union[Unset, GetSubmodelByIdValueOnlyLevel]):  Default:
            GetSubmodelByIdValueOnlyLevel.DEEP.
        extent (Union[Unset, GetSubmodelByIdValueOnlyExtent]):  Default:
