...
def _get_kwargs(
    *,
    ...
    limit: Union[Unset, GetAllSubmodelsLimit] = UNSET,
    cursor: Union[Unset, "Base64UrlEncodedCursor"] = UNSET,
    level: Union[Unset, GetAllSubmodelsLevel] = GetAllSubmodelsLevel.DEEP,
    extent: Union[Unset, GetAllSubmodelsExtent] = GetAllSubmodelsExtent.WITHOUTBLOBVALUE,
) -> Dict[str, Any]:
    params: Dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        limit (Union[Unset, GetAllSubmodelsLimit]):
        cursor (Union[Unset, Base64UrlEncodedCursor]):
        level (Union[Unset, GetAllSubmodelsLevel]):  Default: GetAllSubmodelsLevel.DEEP.
        extent (Union[Unset, GetAllSubmodelsExtent]):  Default:
