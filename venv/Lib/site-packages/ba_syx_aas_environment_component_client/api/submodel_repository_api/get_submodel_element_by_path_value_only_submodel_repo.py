...
from ...models.get_submodel_element_by_path_value_only_submodel_repo_extent import (
    GetSubmodelElementByPathValueOnlySubmodelRepoExtent,
)
from ...models.get_submodel_element_by_path_value_only_submodel_repo_level import (
...
def _get_kwargs(
    ...
    *,
    level: Union[
        Unset, GetSubmodelElementByPathValueOnlySubmodelRepoLevel
    ] = GetSubmodelElementByPathValueOnlySubmodelRepoLevel.DEEP,
    extent: Union[
        Unset, GetSubmodelElementByPathValueOnlySubmodelRepoExtent
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/submodels/{submodel_identifier}/submodel-elements/{id_short_path}/$value",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        submodel_identifier (str):
        id_short_path (str):
        level (Union[Unset, GetSubmodelElementByPathValueOnlySubmodelRepoLevel]):  Default:
            GetSubmodelElementByPathValueOnlySubmodelRepoLevel.DEEP.
        extent (Union[Unset, GetSubmodelElementByPathValueOnlySubmodelRepoExtent]):  Default:
            GetSubmodelElementByPathValueOnlySubmodelRepoExtent.WITHOUTBLOBVALUE.
