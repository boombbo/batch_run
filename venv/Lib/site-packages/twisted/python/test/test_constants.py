...
class NamesTests(TestCase, _ConstantsTestsMixin):
    ...
    def test_iterconstants(self):
        ...
        self.assertEqual(
            [self.METHOD.GET, self.METHOD.PUT, self.METHOD.POST, self.METHOD.DELETE],
            constants,
        )
...
class OrderedConstantsTests(TestCase):
    ...
    def test_orderedDifferentContainers_lt(self):
        ...
        """
        self.assertEqual(
            NotImplemented, NamedLetters.alpha.__lt__(MoreNamedLetters.digamma)
        )
    ...
    def test_orderedDifferentContainers_le(self):
        ...
        """
        self.assertEqual(
            NotImplemented, NamedLetters.alpha.__le__(MoreNamedLetters.digamma)
        )
    ...
    def test_orderedDifferentContainers_gt(self):
        ...
        """
        self.assertEqual(
            NotImplemented, NamedLetters.alpha.__gt__(MoreNamedLetters.digamma)
        )
    ...
    def test_orderedDifferentContainers_ge(self):
        ...
        """
        self.assertEqual(
            NotImplemented, NamedLetters.alpha.__ge__(MoreNamedLetters.digamma)
        )
